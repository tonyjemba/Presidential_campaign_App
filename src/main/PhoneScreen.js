            ...
            <Content className="bg-white">
              <div className="w-100 flex flex-column justify-center items-center">
                ...
                <div
                  ...
                  The middle class isn't a number - it's Collaboratively build a
                  Uganda that we all desire to live in... manifesto manifesto
                    ...
                    <div className="w-90 ">
                      <div className=" w-100" style={{ height: "40vh" }}>
                        <Collapse
                          ...
                          <Panel
                            header={
                              <Title level={4}>This is panel header 1</Title>
                            }
                            key="1">
                          ...
                          <Panel
                            header={
                              <Title level={4}>This is panel header 2</Title>
                            }
                            key="2">
                            <div style={{ fontsize: "16px", color: "#000000" }}>
                              {text}
                          ...
                          <Panel
                            header={
                              <Title level={4}>This is panel header 3</Title>
                            }
                            key="3">
                            <div style={{ fontsize: "16px", color: "#000000" }}>
                              {text}
                          ...
                          <Panel
                            header={
                              <Title level={4}>This is panel header 4</Title>
                            }
                            key="4">
                            <div style={{ fontsize: "16px", color: "#000000" }}>
                              {text}
