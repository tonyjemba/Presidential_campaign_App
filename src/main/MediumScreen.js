                  ...
                  <div className="w-90 flex flex-row justify-between">
                    ...
                    <div className="w-60 flex flex-row justify-between">
                      <div
                        ...
                        style={{ fontSize: "3vw" }}>
                        Finally A <br /> Cause That's <br /> Worth Our <br /> Full <br />{" "}
                        Attention.
                      </div>
                      <div className="w-50 h-100 flex flex-column items-center justify-center">
                        <div className="fw7 white " style={{ fontSize: "1.8vw" }}>
                          ...
                          <div className=" w-100" style={{ height: "40vh" }}>
                            <Collapse
                              ...
                              <Panel
                                ...
                                key="1">
                                <div style={{ fontsize: "2.3vw", color: "#000000" }}>
                                  {text}
                                </div>
                              </Panel>
                              <Panel
                              ...
                              <Panel
                                ...
                                key="4">
                                <div style={{ fontsize: "2.vw", color: "#000000" }}>
                                  {text}
                                </div>
                              </Panel>
                            </Collapse>
            ...
            <div className="w-90  flex flex-row justify-between">
              <div
                ...
                <div className="tc w-100 absolute top-0 black">
                  ...
                  <span
                    ...
                    <span style={{ color: "#ff0000", backgroundColor: "#ff0000" }}>
                      llljemba tonylll
                    </span>
                  </span>
                </div>
              ...
              <div className=" flex items-center justify-center pr2">
                <div
                  ...
                  onClick={() => previous()}>
                  <CaretLeftOutlined className="pa2 " style={{ color: "#ffffff" }} />
                </div>
              </div>
              ...
              <div className=" flex items-center justify-center pl2">
                <div
                  ...
                  onClick={() => next()}>
                  <CaretRightOutlined className="pa2 " style={{ color: "#ffffff" }} />
                </div>
              </div>
            </div>
          </div>
