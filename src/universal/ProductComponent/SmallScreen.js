...
const SmallScreen =() =>{
    return(
        <div className="flex flex-column justify-center items-center">
            <div className="w-33 pointer" style={{height:"30vh"}}>
            <img src={product} alt="product" className="productimg"/>
            </div>
            <div className = "fw6 pointer" style={{fontSize:"2.5vw",color:"#000000"}}>product Name</div>
            <div className = "fw4 pointer" style={{fontSize:"2.3vw",color:"#000000"}}>UGX 10000</div>
