            ...
            <div className="absolute   w-100 h-100 overlay flex flex-column justify-between">
              <div className=" w-100 flex justify-center">
                <div className="w-90 flex flex-row justify-between  white">
                  <div>
                    <div className="mt3  fw6" style={{ fontSize: "1.5vw" }}>
                      About
                    </div>
                    <div className="mt4 " style={{ fontSize: "15px" }}>
                    ...
                    <div className="mt3 f5" style={{ fontSize: "15px" }}>
                      ...
                      <span
                        className="pointer"
                        style={{ color: "#0C0474", fontSize: "15px" }}
                      >
                        info@nupuganda.org
                      </span>
                    </div>
                    <div className="mt2 f5" style={{ fontSize: "15px" }}>
                      Visit Us:{" "}
                      <span
                        className="pointer"
                        style={{ color: "#0C0474", fontSize: "15px" }}
