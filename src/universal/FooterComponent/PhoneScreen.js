              ...
              <div className=" w-100 tbg flex justify-center">
                <div className="w-90 flex flex-column justify-between">
                  <div className=" w-100 mt4 mb4">
                    <div className="fw7 " style={{ fontSize: "3.8vw" }}>
              ...
              <div className=" w-100 flex justify-center">
                <div className="w-90 flex flex-row justify-between  white">
                  <div>
                    ...
                    <div className="mt3 f5" style={{ fontSize: "3vw" }}>
                      Email Us:{" "}
                      <span
                        className="pointer"
                        style={{ color: "#0C0474", fontSize: "3vw" }}>
                        info@nupuganda.org
                      </span>
                    </div>
                    <div className="mt2 f5" style={{ fontSize: "3vw" }}>
                      Visit Us:{" "}
                      <span
                        className="pointer"
                        style={{ color: "#0C0474", fontSize: "3vw" }}>
                  ...
                  <div>
                    ...
                    <div className="mt4">
                      <div className=" w-90" style={{ fontSize: "3vw" }}>
                        We are unvieling a new campaing...
                      </div>
                      <div className="flex flex-row justify-between">
                        <div className="myc" style={{ fontSize: "3vw" }}>
                          05 Nov, 2020
                        </div>
                        <div
